...
function BookingDataBox({ booking }) {
    const {
        ...
        observations,
        is_paid,
        Guests: { name: guestName, email, nationality, country, nationalID },
        ...
        <StyledBookingDataBox>
            <Header>
                <div>
                    <HiOutlineHomeModern />
                    <p>
                        {nights_stay} nights in Cabin <span>{cabinName}</span>
                    </p>
                </div>
            ...
            <Section>
                <Guest>
                    {country && (
                        <Flag src={country} alt={`Flag of ${nationality}`} />
                    )}
                    <p>
                        {guestName}{' '}
                        {total_guests > 1 ? `+ ${total_guests - 1} guests` : ''}
                    </p>
                    <span>&bull;</span>
                    <p>{email}</p>
                    <span>&bull;</span>
